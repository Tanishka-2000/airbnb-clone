    ...
    return(
        <div className='hotel-form'>
            <div className='form-heading'>
                <div><span className='bold big'>&#8377; {Math.round(pricePerN * Number(indianExhangeRate) * 100)/100} </span>night</div>
            ...
            <div className='rate'>
                <div><span>&#8377; {Math.round(pricePerN * indianExhangeRate * 100) / 100} X 5 nights</span><span>&#8377; {Math.round(pricePerN * indianExhangeRate * 500) / 100}</span></div>
                <div><span>Cleaning fee</span><span>0</span></div>
                <div><span>Service fee</span><span>0</span></div>
            </div>
            <div className='total-rate'><span>Total before taxes</span><span>&#8377; {Math.round(pricePerN * indianExhangeRate * 500) / 100}</span></div>
        </div>
    )
}
